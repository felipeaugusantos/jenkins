...
svn checkout -q svn://srvprg1.citelsoftware.com.br/Padrao/027.18/27.18.379/379.48.02.REV.FECHADAs/379.48.02.30.FECHADAS/releaseversion %WORKSPACE%
...
copy /Y %WORKSPACE%\padra_atualizado\Shared.Functions.bpl C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\faturamento.impostos.interfaces.bpl C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\faturamento.impostos.tipos.bpl C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\faturamento.model.bpl C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\faturamento.impostos.calculos.bpl C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\faturamento.impostos.regras.bpl C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\faturamento.impostos.servicos.bpl C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\faturamento.precos.interfaces.bpl C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\faturamento.precos.tipos.bpl C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\faturamento.precos.calculos.bpl C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\faturamento.precos.servicos.bpl C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\faturamento.margem.interfaces.bpl C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\faturamento.margem.tipos.bpl C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\faturamento.margem.calculos.bpl C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\faturamento.margem.servicos.bpl C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\Login.View.bpl C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\Tintas.View.bpl C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\Autoatendimento.PagueFacil.View.bpl C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\Autoatendimento.ConsultaPreco.View.bpl C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\Principal.View.bpl C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\autcom.exe C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\libFuncoes.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\libFiscalCat42.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\libReinf.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\EnviaEmailBoletoMonitor.exe C:\VERSOES_FECHADAS\releaseversion

CALL C:\Compilador\ddcc32NovoDX10.cmd iLogMonitorSend %WORKSPACE%\padra_atualizado\Monitors\iLogMonitor\Send\ %WORKSPACE%\padra_atualizado\
IF NOT %ERRORLEVEL% == 0 GOTO END
C:\Compilador\madExceptPatch.exe %WORKSPACE%\padra_atualizado\iLogMonitorSend.exe
copy /Y %WORKSPACE%\padra_atualizado\iLogMonitorSend.exe C:\VERSOES_FECHADAS\releaseversion
...
IF NOT %ERRORLEVEL% == 0 GOTO END
C:\Compilador\madExceptPatch.exe %WORKSPACE%\padra_atualizado\iLogMonitorStatus.exe
copy /Y %WORKSPACE%\padra_atualizado\iLogMonitorStatus.exe C:\VERSOES_FECHADAS\releaseversion

CALL C:\Compilador\ddcc32NovoDX10.cmd AutBan %WORKSPACE%\autban\Autban_dll\ %WORKSPACE%\padra_atualizado\autban
IF NOT %ERRORLEVEL% == 0 GOTO END
C:\Compilador\madExceptPatch.exe %WORKSPACE%\padra_atualizado\autban\AutBan.exe
copy /Y %WORKSPACE%\padra_atualizado\autban\AutBan.exe C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\AutcomTinta.dll C:\VERSOES_FECHADAS\releaseversion

CALL C:\Compilador\ddcc32NovoDX10.cmd AutTin %WORKSPACE%\Auttin\ %WORKSPACE%\padra_atualizado\auttin
IF NOT %ERRORLEVEL% == 0 GOTO END
C:\Compilador\madExceptPatch.exe %WORKSPACE%\padra_atualizado\auttin\AutTin.exe
copy /Y %WORKSPACE%\padra_atualizado\auttin\AutTin.exe C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\libEditorEtiquetas.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\ConsultaPagamentosPixMonitor.exe C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\libGNRE.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\libImpExtEletronico.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\libIntegracaoCartoes.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\libIntegracaoPixCitel.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\libNfe.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\libOpeRefProd.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\libPedidoDeCompra.dll C:\VERSOES_FECHADAS\releaseversion

CALL C:\Compilador\ddcc32NovoDX10.cmd libRelEstatistica %WORKSPACE%\padra_atualizado\fontes\relatorios_dll\estatistica\ %WORKSPACE%\padra_atualizado\
IF NOT %ERRORLEVEL% == 0 GOTO END
C:\Compilador\madExceptPatch.exe %WORKSPACE%\padra_atualizado\libRelEstatistica.dll
copy /Y %WORKSPACE%\padra_atualizado\libRelEstatistica.dll C:\VERSOES_FECHADAS\releaseversion

CALL C:\Compilador\ddcc32NovoDX10.cmd libRelEstoque %WORKSPACE%\padra_atualizado\fontes\relatorios_dll\estoque\ %WORKSPACE%\padra_atualizado\
IF NOT %ERRORLEVEL% == 0 GOTO END
C:\Compilador\madExceptPatch.exe %WORKSPACE%\padra_atualizado\libRelEstoque.dll
copy /Y %WORKSPACE%\padra_atualizado\libRelEstoque.dll C:\VERSOES_FECHADAS\releaseversion

CALL C:\Compilador\ddcc32NovoDX10.cmd libRelFatGeral %WORKSPACE%\padra_atualizado\fontes\relatorios_dll\faturamento\geral\ %WORKSPACE%\padra_atualizado\
IF NOT %ERRORLEVEL% == 0 GOTO END
C:\Compilador\madExceptPatch.exe %WORKSPACE%\padra_atualizado\libRelFatGeral.dll
copy /Y %WORKSPACE%\padra_atualizado\libRelFatGeral.dll C:\VERSOES_FECHADAS\releaseversion

CALL C:\Compilador\ddcc32NovoDX10.cmd libRelFatEvolucaoVendas %WORKSPACE%\padra_atualizado\fontes\relatorios_dll\faturamento\EvolucaoVendas\ %WORKSPACE%\padra_atualizado\
IF NOT %ERRORLEVEL% == 0 GOTO END
C:\Compilador\madExceptPatch.exe %WORKSPACE%\padra_atualizado\libRelFatEvolucaoVendas.dll
copy /Y %WORKSPACE%\padra_atualizado\libRelFatEvolucaoVendas.dll C:\VERSOES_FECHADAS\releaseversion

CALL C:\Compilador\ddcc32NovoDX10.cmd libRelFatComissao %WORKSPACE%\padra_atualizado\fontes\relatorios_dll\faturamento\Comissao\ %WORKSPACE%\padra_atualizado\
IF NOT %ERRORLEVEL% == 0 GOTO END
C:\Compilador\madExceptPatch.exe %WORKSPACE%\padra_atualizado\libRelFatComissao.dll
copy /Y %WORKSPACE%\padra_atualizado\libRelFatComissao.dll C:\VERSOES_FECHADAS\releaseversion

CALL C:\Compilador\ddcc32NovoDX10.cmd libRelFatMetas %WORKSPACE%\padra_atualizado\fontes\relatorios_dll\faturamento\Metas\ %WORKSPACE%\padra_atualizado\
IF NOT %ERRORLEVEL% == 0 GOTO END
C:\Compilador\madExceptPatch.exe %WORKSPACE%\padra_atualizado\libRelFatMetas.dll
copy /Y %WORKSPACE%\padra_atualizado\libRelFatMetas.dll C:\VERSOES_FECHADAS\releaseversion

CALL C:\Compilador\ddcc32NovoDX10.cmd libRelFatVendas %WORKSPACE%\padra_atualizado\fontes\relatorios_dll\faturamento\Vendas\ %WORKSPACE%\padra_atualizado\
IF NOT %ERRORLEVEL% == 0 GOTO END
C:\Compilador\madExceptPatch.exe %WORKSPACE%\padra_atualizado\libRelFatVendas.dll
copy /Y %WORKSPACE%\padra_atualizado\libRelFatVendas.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\libTefCitel.dll C:\VERSOES_FECHADAS\releaseversion

CALL C:\Compilador\ddcc32NovoDX10.cmd libRelLivrosFiscais %WORKSPACE%\padra_atualizado\fontes\relatorios_dll\livrosfiscais\ %WORKSPACE%\padra_atualizado\
IF NOT %ERRORLEVEL% == 0 GOTO END
C:\Compilador\madExceptPatch.exe %WORKSPACE%\padra_atualizado\libRelLivrosFiscais.dll
copy /Y %WORKSPACE%\padra_atualizado\libRelLivrosFiscais.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\PainelNFe.exe C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\NFeImpressao.exe C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\NFeStatus.exe C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\libTransfCodigo.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaNexa.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaPpg.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaPpgNexa.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaFarbenAutomotiva.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaSkyMixAutomotiva.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaMaxVinil.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaMiniFabrica.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaSherwinWilliams2.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaAdvance.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaAdvanceStr.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaAdvanceTintoSystem.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaAlessiImobiliaria.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaAlterPlus.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaAnjoAutomotiva.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaAnjoImobiliaria.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaAnjoImobiliaria2.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaAnjoSintetica.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaAnnetta.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaAutoluks.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaBautech.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaBellaCor.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaBrasimixAutomotiva.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaBrasimixImobiliaria.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaBrazilianColorAutomotiva.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaCalamar.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaCiacollor.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaColorPro.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaColorbraz.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaCoralImobiliaria.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaDacar.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaDupont.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaDuxone.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaDuxone2.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaEucatexImobiliaria.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaFalcao.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaFutura.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaGeneral.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaGlobalCc11.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaGlobalColor.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaGrafftex.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaHydronorthImobiliaria.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaInkor.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaInternational.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaIquine.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaJotun.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaKilling.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaKillingIndustrial.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaKresil.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaLazzumix.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaLechler.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaLeinertex.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaLiko.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaLukscolor.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaLukscolor2.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaMazaAutomotiva.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaMazaImobiliaria.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaMazaIndustrial.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaMegaTintas.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaMontana.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaQualyVinil.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaRecoa.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaRennerImobiliaria.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaRennerIndustrial.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaRennerPerformance.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaResicolor.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaResicolor2.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaRoberlo.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaSayerlack.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaSherwinWilliams.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaSinteplast.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaSparlack.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaStandox.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaStarmix.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaStarmixWeb.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaSuvinil.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaTexturaCia.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaTopCoat.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaUniverso.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaVelutexImobiliaria.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaWeg.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaBellaCorTintavel.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaGlobalBc.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaGlobalBsn.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaGlobalCsn.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaChreon.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaProfissionalTintas.dll C:\VERSOES_FECHADAS\releaseversion


echo concluido > C:\VERSOES_FECHADAS\releaseversion\concluido.txt

:: Copia a pasta completa para a versão CLOUD
rd /s /q "C:\VERSOES_FECHADAS\releaseversion_CLOUD"
xcopy /E /I /Y "C:\VERSOES_FECHADAS\releaseversion" "C:\VERSOES_FECHADAS\releaseversion_CLOUD\"

:: Remove o arquivo de controle do build da versão CLOUD
del /q "C:\VERSOES_FECHADAS\releaseversion_CLOUD\concluido.txt"

:: Comenta o comando upx.exe e substitui todas as referencias a versao por _CLOUD nos .bat e .cmd
powershell -NoProfile -Command "Get-ChildItem 'C:\VERSOES_FECHADAS\releaseversion_CLOUD\comandosCMD' | Where-Object { $_.Extension -eq '.bat' -or $_.Extension -eq '.cmd' } | ForEach-Object { $c = Get-Content $_.FullName; $c = $c.Replace('C:\Compilador\upx.exe', '::C:\Compilador\upx.exe'); $c = $c.Replace('releaseversion', 'releaseversion_CLOUD'); Set-Content $_.FullName $c }"

:: Executa configurações e inicia o sistema após compilação completa
CALL C:\VERSOES_FECHADAS\releaseversion\comandosCMD\__RodarPrimeiro.bat
schtasks /run /tn releaseversion_Principal

:: Executa configurações e inicia o sistema da versão CLOUD
CALL C:\VERSOES_FECHADAS\releaseversion_CLOUD\comandosCMD\__RodarPrimeiro.bat
schtasks /run /tn releaseversion_CLOUD_Principal

:END
@ECHO OFF
if not exist "C:\VERSOES_FECHADAS\releaseversion\concluido.txt" (
    java -jar "C:\Utilitarios\JenkinsJar\jenkins-cli.jar" -s http://localhost:8080/ console releaseversion -n 20 > C:\VERSOES_FECHADAS\releaseversion\erro.txt
    EXIT /b 1
)
