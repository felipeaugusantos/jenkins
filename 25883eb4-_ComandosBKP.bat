...
copy /Y %WORKSPACE%\auttin\Auttin\libAuttin.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\FatImpressao.exe C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\libCartoes\libCartoesMobbuy\libCartoesMobbuy.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaDacasa.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaMaestria.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaLuztol.dll C:\VERSOES_FECHADAS\releaseversion
