...
copy /Y %WORKSPACE%\padra_atualizado\libLayoutsFR3.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\libCadastros.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\ConsultaPitStop.exe C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\autban\Autban_dll\libAutban.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaGlobalCcn13.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaLechlerAutomotiva.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaVerbras.dll C:\VERSOES_FECHADAS\releaseversion
...
copy /Y %WORKSPACE%\padra_atualizado\auttin\tintas\libTintaParis.dll C:\VERSOES_FECHADAS\releaseversion
